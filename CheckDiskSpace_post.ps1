...
# EMAIL PROPERTIES
	# Set the recipients of the report.
		#$users = "toneal650@gmail.com"
  		$users = @("mtaylor@mt-technology.com","mactaylor@mpspg.com","mactaylorii@gmail.com") # I use this for testing by uing my email address.


# REPORT PROPERTIES
	# Path to the report
		$reportPath = "C:\dropbin\manifest\";
...
# $computers = Get-Content "caps-ws09";
    ...
    foreach ($user in $users)
{
		...
		$msg.To.Add($user)
        $msg.From = "mactaylorii@gmail.com"
